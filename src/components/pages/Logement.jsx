  ...
  return (
		...
		<main className='container'>
			...
			<Wrapper>
				...
				<BoxAvatare>
					<Avatar url={logement.host.picture} alt={logement.host.name} children={logement.host.name} />
					<RatingStars rating={parseInt(logement.rating)} />
				</BoxAvatare>
				<div className='center'>
					<AccordionLog size="small" title="Description" children={logement.description} open/>
				</div>
				<div className='center'>
					<AccordionLog size="small" title="Équipement" children={logement.equipments} open/>
				</div>
			</Wrapper>
		</main>
	<Footer />
